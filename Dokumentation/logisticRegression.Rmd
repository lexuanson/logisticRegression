...
&= - \sum_{i = 1}^{n} \Big( \mathbf{x'}_i.\mathbf{x}_i . (1-\pi_i) . \pi_i \Big) \quad (16) \\
\end{aligned}
$$

Sei M eine nxn-Matrix mit dem i-ten diagonalen Element $M_{ii} = \pi_i.(1-\pi_i)$ mit $i \in (1,2,...,n)$, ergibt sich: 
$$
...
$$
\begin{aligned}
\beta_{n+1} &= \quad \beta_n - \frac{s(\beta)}{s'(\beta)} \\
&\mathrel{\overset{(15),(16)}{=}} \beta_n 
\end{aligned}
$$
