...
@schlittgen2013regressionsanalysen, S.236-237 zeigt, dass die Wahrscheinlichkeitsfunktion vom binären Logit-Modell sich mit der Exponentialfunktion schreiben lässt. Somit erfüllt das binäre Logit-Modell alle Anforderungen für ein GLM.
...
4. **Residual vs Leverage**: identifiziert einflussreiche Beobachtungen. Hierbei werden zwei neue Kennwerte ermittelt [^cite02].
...
[^cite02]: vgl. https://web.as.uky.edu/statistics/users/pbreheny/760/S11/notes/4-12.pdf 
