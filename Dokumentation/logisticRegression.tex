...
In der Summary-Methode werden zunächst lediglich bisher noch fehlende
Werte berechnet: * \textbf{Standard Error} der Koeffizienten *
\textbf{z-Stat} * \textbf{p-Value} *
...
Einordnung der jeweiligen Werten.

\emph{print.summaryDefault }printCoefmat *invisible
