...
Kleinsten Quadrate (engl. \emph{method of least squares}, kurz
KQ-Methode) genutzt wird, um eine Regressionslinie zu bestimmen, welche
die Summe der quadratischen Abweichungen minimiert, wird bei dem binären
Logit-Modell die sogenannte Maximum Likelihood Schätzung eingesetzt.
Abbildung .. zeigt ein Beispiel mit zwei mögliche binäre logistiche
Regressionskurven.
